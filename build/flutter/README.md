...
* `obsidian_capture` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `obsidian_capture` - executable or bundle name on disk.
* `obsidian_capture` - display name shown in window titles and about app dialogs.
